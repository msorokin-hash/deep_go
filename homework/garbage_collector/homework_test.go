...
func traceDFS(curr uintptr, result *[]uintptr, visited map[uintptr]struct{}) {
	if _, ok := visited[curr]; ok || curr == 0 {
		return
	}
	visited[curr] = struct{}{}
	...
	*result = append(*result, curr)
	...
	traceDFS(*(*uintptr)(unsafe.Pointer(curr)), result, visited)
}
